...
Serializer = Callable[[Any, Any, SerializationInfo], Any]

F = TypeVar("F", bound=Serializer)


def field_serializer(field_name: str):
    """装饰器: 注册字段的自定义 Tarsio 序列化方法.
    ...
    def decorator(func: F) -> F:
        cast(Any, func).__tars_serializer_target__ = field_name
        return func
